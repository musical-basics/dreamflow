...
export class Font {
    ...
    static load(fontName, url, descriptors) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const loadedFontFace = yield fontFace.load();
            let fontFaceSet;
            ...
            fontFaceSet === null || fontFaceSet === void 0 ? void 0 : fontFaceSet.add(loadedFontFace);
            if (typeof document !== 'undefined') {
                try {
                    yield document.fonts.load(`30px "${fontName}"`);
                }
                catch (_a) {
                }
            }
